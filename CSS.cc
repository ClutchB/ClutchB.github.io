...
<html lang="en">
	<head>
		...
		<title>Oral Boothe-Crash Course</title>
	...
	<body>
			...
			<div class="container">
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
						...
						<li><a href="current topic.html">Current Topic</a></li>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREZfhlN7h__o92V0gwlzklBOL0ePuGWYxpDyVLL_ZY4DnYld2h)"></div>
			<!-- /Backgound Image -->
